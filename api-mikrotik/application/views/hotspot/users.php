                            ...
                            <tbody>
                                <?php foreach ($hotspotuser as $data) { ?>
                                    <tr>
                                        ...
                                        <th>
                                        <a href="<?= site_url('hotspot/delUser/' . $id) ?>" onclick="return confirm('Apakah yakin akan hapus User <?= $data['name']; ?> ?')"><i class="fa fa-trash" style="color:red"></i></a>
            ...
            <form action="<?= site_url('hotspot/addUser') ?>" method="POST">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="timelimit" class="form-control" id="timelimit" placeholder="">
                    </div>
                    <div class="form-group">
