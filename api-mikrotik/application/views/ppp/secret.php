<div class="content-wrapper mt 1">
    <div class="content-header">
        <div class="container-fluid">
            ...
            <div class="card-body">
                <button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#modal-add-secret">
                    Add <?= $title; ?>
                </button>
            </div>
            <div class="row">
                            ...
                            <tbody>
                                <?php foreach ($secret as $data) { ?>
                                    <tr>
                                        ...
                                        <th>
                                            <!-- Delete -->
                                            <a href="<?= site_url('ppp/delSecret/' . $id) ?>" onclick="return confirm('Apakah yakin akan hapus PPP Secret <?= $data['name']; ?> ?')"><i class="fa fa-trash" style="color:red"></i></a>
                                            <!-- Edit -->
